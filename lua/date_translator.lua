...
function M.init(env)
    ...
    M.date = config:get_string('key_binder/' .. env.name_space .. '_date') or 'rq'
    M.time = config:get_string('key_binder/' .. env.name_space .. '_time') or 'sj'
    M.week = config:get_string('key_binder/' .. env.name_space .. '_week') or 'xq'
    M.datetime = config:get_string('key_binder/' .. env.name_space .. '_datetime') or 'dt'
    M.timestamp = config:get_string('key_binder/' .. env.name_space .. '_timestamp') or 'ts'
end
